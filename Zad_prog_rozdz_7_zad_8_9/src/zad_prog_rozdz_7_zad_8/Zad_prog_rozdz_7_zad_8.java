...
public class Zad_prog_rozdz_7_zad_8 {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            r.setNames(JOptionPane.showInputDialog(null, "Imię i nazwisko studenta nr " + (i + 1) + ": "));
            
            test = Integer.parseInt(JOptionPane.showInputDialog(null, "Wynik testu nr 1 (liczba z zakresu od 0 do 100): "));
            ...
            test = Integer.parseInt(JOptionPane.showInputDialog(null, "Wynik testu nr 2 (liczba z zakresu od 0 do 100): "));
            ...
            test = Integer.parseInt(JOptionPane.showInputDialog(null, "Wynik testu nr 3 (liczba z zakresu od 0 do 100): "));
            ...
            test = Integer.parseInt(JOptionPane.showInputDialog(null, "Wynik testu nr 4 (liczba z zakresu od 0 do 100): "));
